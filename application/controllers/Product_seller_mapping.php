...
class Product_seller_mapping extends MY_Controller { 
    ...
    public function delete_a_mapping($id) {
        ...
        if ($this->input->post('mapping_id')) {
            ...
            $mapping_object = $this->product_seller_mapping_model->get_one_mapping($id);
            ...
            $product_object = $this->product_model->get_one_product($mapping_object->product_id);
            $product_object = $product_object[0];
            $data['product_name'] = $product_object->product_name;

            $seller_object = $this->seller_model->get_one_seller($mapping_object->seller_id);
            $seller_object = $seller_object[0];
