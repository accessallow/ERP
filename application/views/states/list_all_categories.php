<div class="row">
    ...
    <div class="col-md-5" style="text-align: right;">
        <a class="btn btn-success btn-xs" href="<?php echo URL_X . 'States/add_new'; ?>">Add new state</a>
    </div>
</div>
<br/>
    ...
    <div class="col-md-5">
        <table class="table table-hover table-striped">
            ...
            <tr ng-repeat="category in categories|filter:m">
                <td>
                    <a href="<?php echo URL_X; ?>Product?state_id={{category.id}}">
                        {{category.state_name}}
                    </a>
                </td>
                ...
                <td style="text-align: right;">
                    ...
                    <a href="<?php echo URL_X . 'States/edit/'; ?>{{category.id}}" class="btn  btn-primary btn-xs">Edit</a>
                    <a href="<?php echo URL_X . 'States/delete/'; ?>{{category.id}}" class="btn  btn-danger btn-xs">Delete</a>
                </td>
            </tr>
