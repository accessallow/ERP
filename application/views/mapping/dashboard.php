    ...
    <div class="col-md-10">
        ...
        <div class="row">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    Crop Association
                    <button class="btn btn-xs btn-warning pull-right" ng-click="toggle_crop();">Toggle Check</button>
                </div>
                <div class="panel-body">
                    ...
                    <form action="<?php echo site_url('Product/attach_crop'); ?>" method="post">
                        ...
                        <?php foreach ($crops as $c) { ?>
                            ...
                            <input type="checkbox" class="crop_checkbox" name="check_list[]" value="<?php echo $c->slug; ?>"
                            <?php
                ...
                <div class="panel-body">
                    ...
                    <form action="<?php echo site_url('Product/attach_screen'); ?>" method="post">
                        ...
                        <?php foreach ($cropScreens as $cs) { ?>
                            <p 
                                style="background: #2d4458;color:white;padding: 2px;font-weight: bold;padding-top: 5px; padding-bottom: 5px;"
                                ><?php echo $cs->crop_name; ?>
                             <?php
                                     $class = 'checkbox_'.$cs->slug;
                             ?>
                            <button class="btn btn-xs btn-warning pull-right" ng-click="toggle_checkbox('<?php echo $class;?>');">Toggle Check</button>
                            </p>   
                            
                            
                                <?php foreach ($cs->screens as $scr) { ?>                 

                                <input type="checkbox" class="<?php echo $class; ?>" name="screen_check_list[]" value="<?php echo $scr->screen_name; ?>"
        ...
        <div class="row">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    Version Mapping
                    <a href="<?php echo site_url('Mapping/addVersionMapping/' . $product->id); ?>" class="btn btn-xs btn-warning">Add mapping</a>
                </div>
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            <?php foreach ($version_mapping as $m) { ?>
                                <tr>
                                    <td><?php echo $m->version_name; ?></td>
                                    
                                    <td>
                                        <!--<a href="<?php echo site_url('Mapping/addVersionMapping/' . $product->id); ?>" class="btn btn-primary btn-xs">Edit</a>-->
...
<script>
    ...
    app.controller('dashboardController', ['$scope', '$http', function ($scope, $http) {
            ...
            $scope.toggle_crop = function(){
                 var checkBoxes = $(".crop_checkbox");
                 checkBoxes.prop("checked", !checkBoxes.prop("checked"));
            }
            
            $scope.toggle_checkbox = function(checkbox_class){
                var cb_class = "."+checkbox_class;
