<h3>Add new crop</h3>
<hr/>
<form class="form-horizontal"   data-parsley-validate role="form" action="<?php echo URL_X . 'Disease/add_new'; ?>" method="POST">
    <div class="form-group">
        <label for="crop_name" class="col-sm-2 control-label">Disease Name</label>
        <div class="col-sm-4">
            <input type="text"
                   autofocus="autofocus"
