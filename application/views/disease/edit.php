<form class="form-horizontal" role="form"   data-parsley-validate action="<?php echo URL_X . 'Disease/edit'; ?>" method="POST">
    <?php
    if (!isset($crop)) {
    ...
    <div class="form-group">
        <label for="seller_name" class="col-sm-2 control-label">Disease Name</label>
        <div class="col-sm-4">
            <input type="text" 
                   autofocus="autofocus"
                   class="form-control" required name="crop_name" value="<?php echo $crop->disease_name; ?>" placeholder=""/> 
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            ...
            <a accesskey="c" href="<?php echo URL_X . 'Disease/'; ?>" class="btn btn-primary">Back</a>
        </div>
    ...
    app.controller('SlugController', ['$scope', '$http', function ($scope, $http) {
            ...
            $scope.checkSlugAvailable = function (slug) {
                ...
                if (slug == undefined) {
                    ...
                    $http.get('<?php echo site_url('Disease/slugAvailable'); ?>/' + slug).success(function (data) {
                        console.log(data);
