            ...
            <tbody>
                <tr ng-repeat="product in products|filter:m">
                    <td>
                        ...
                        <a href="<?php echo site_url('Web/product/');?>/{{product.id}}" class="btn btn-primary btn-xs pull-right"><span class="glyphicon glyphicon-file"></span></a>
...
<!--                            link to inventories done for this product-->
                ...
                <a class="badge" style="background: #0063dc;color:white;" href="<?php echo URL_X; ?>Mapping/product_mapping/{{product.id}}">Mapping</a>
                        </td>
                    <?php } ?>
