<h3>Add new mapping to seller: <strong><?php echo $seller->seller_name?></strong></h3>
...
<div ng-controller="BlockController">
    <form class="form-horizontal" data-parsley-validate role="form" action="<?php echo site_url('Coverage/addMapping/'.$seller->id); ?>" method="POST">
